...
Project Overview:
This project simulates an ETL (Extract, Transform, Load) process in the finance sector using Python and SQL. You will work with a sample financial dataset, performing the following steps:
...
Filtering: Extract records for customers with account balances over $10,000.
Joining: Combine data from Customers and Transactions to create a detailed view of customer transaction history.
Aggregation: Calculate the total amount of deposits and withdrawals for each customer.
